...
class ClNeuralNetwork:
    ...
    def adjust_weights(self, input_samples, error):
        ...
        # print "self.layers[0].weigths", self.layers[0].weights.shape
        # print "input_samples.shape", input_samples.shape, input_samples
        ...
        self.layers[0].weights = self.layers[0].weights + self.learning_rate * np.dot(error, input_matrix_with_ones.T)
