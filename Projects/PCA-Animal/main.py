...
nnet = NeuralNetwork(lr=0.01, sizes=[50, 25, 10], seed=1234, n_epochs=50)
...
print("Classification accuracy = %f, among %d classes" % (accuracy, len(animal_labels)))
